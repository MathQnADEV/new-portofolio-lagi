...
const Dashboards = () => {
    return(
        <><div className="text-center p-0 dark:text-white">
        ...
        </div><div className="text-5xl flex justify-center gap-16 py-3 text-gray-600 dark:text-white">
                <a
            ...
            </div><div className="realtive mx-auto bg-gradient-to-b from-teal-500 rounded-full w-80 h-80 mt-20 overflow-hidden md:w-96 md:h-96">
                <Image
                    src={deved}
